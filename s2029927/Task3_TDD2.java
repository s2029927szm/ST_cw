...
public class Task3_TDD2 {
	...
	/**
	 * Declaration: Where Task3_TDD2 is different from Task3_TDD1 ?
	 * 
	 * Only copy the tests of support bulk insert addAll() method, and change the method name into addAllByBulk().
	 * The reason for this is because I keep the code of support bulk insert part in the final Parser.java file.
	 * As I process the coursework on sequence, so I just design the group initialization method compatible with
	 * the support bulk addAll(). Therefore, I keep the both code, and rename the bulk part as addAllByBulk().
	 */
	
	@Test
    public void testbybulk_1236() {
		/**
		...
		parser.addAllByBulk("opt1    opt2 opt3", "o1 o2 o3 o4", "STRING INTEGER BOOLEAN");//#0
    ...
    @Test
    public void testbybulk_4() {
        /**
		 * this tests for addAll support bulk insertion of option
		 * 
		 * Test for bulk specification 4: #0 use no shortcut for 'shortcuts is optional'
		 */
        parser.addAllByBulk("opt1 opt2 opt3", "STRING INTEGER BOOLEAN");//#0
        parser.parse("--opt1=1 --opt2=2 --opt3=true");
    ...
    public void testbybulk_5() {
		 ...
		 */
        parser.addAllByBulk("opt1    opt2", "o1", "STRING INTEGER");//#0
    ...
    public void testbybulk_7() {
		 ...
		 */
        parser.addAllByBulk("opt1 opt2 opt3 opt4","o1 o2 o3 o4", "STRING");//#0
